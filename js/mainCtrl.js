...
app.controller('mainCtrl', function($scope, itunesService){
  ...
  $scope.gridOptions = {
      ...
      columnDefs: [
        ...
        {field: 'TrackPrice', displayName: 'TrackPrice'},
  ...
  // $scope.filterOptions = [
  //   {label: "All", value: "songData"},
  //   {label: "Music Video", value: "music-video"},
  //   {label: "Music", value: "song"},
  //   {label: "Movies", value: "feature-movie"},
  //   {label: "PodCast", value: "podcast"},
  //   {label: "TV Show", value: "tv-episode"}
  ...
  */
  ...
  // displayArray = [{
  //   AlbumArt: songData[artworkUrl30],
  ...
  // }];
    // for(key in songData) {
    //   displayArray.push(songData[artworkUrl30], songData[artist], songData[collectionName], songData[collectionPrice], songData[previewUrl], songData[kind])
    // }
    ...
    // var variable = new DisplayConst($scope.songData)
    

    // var getArrayObj = function(){
    //   itunesService.getArtist(mainData)
    //     .then(function(DisplayConst){
    //       for (key in DisplayConst) {
    //       displayArray.push(songData[key])
    //       }
    //     })
    //   }
